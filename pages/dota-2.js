...
export default function Dota2({ games }) {
    let game = games['dota-2'];
    ...
    return (
        <div>
            <div className="flex items-center h-64 bg-center bg-cover bg-no-repeat border-b-[12px] border-dota2" style={{ backgroundImage: `url('${game?.banner}')` }}>
